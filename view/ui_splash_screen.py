...
"}")
        ...
        self.label_title.setStyleSheet(u"color: #93deed;")
...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>MIO</strong> Ai-Cam", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Version</strong>: v1.0.0.345", None))
    # retranslateUi
